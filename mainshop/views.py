...
from mainshop.forms import OrderForm
from mainshop.utils import recalc_cart
from django.db import transaction


# Create your views here.
from mainshop.models import Notebook, Smartphone, Category, LatestProducts, CartProduct, Customer
from mainshop.mixins import CategoryDetailMixin, CartMixin
...
class BaseView(CartMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        context = {"categories": categories,
                   "products": products,
                   "cart": self.cart}
        return render(request, "mainshop/base.html", context)
...
class ProductDetailView(CartMixin, CategoryDetailMixin, DetailView):
    ...
    template_name = "mainshop/product_detail.html"
    slug_url_kwarg = "slug"
...
class CategoryDetailView(CartMixin, CategoryDetailMixin, DetailView):
    ...
    template_name = "mainshop/category_detail.html"
    slug_url_kwarg = "slug"
...
class AddToCartView(CartMixin, View):
    def get(self, request, *args, **kwargs):
        ct_models, product_slug = kwargs.get("ct_models"), kwargs.get("slug")
        content_type = ContentType.objects.get(model=ct_models)
...
class ChangeQTYView(CartMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, "Количество успешно изменнено")
        return HttpResponseRedirect("/cart/")
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_order.phone = form.cleaned_datap["phone"]
